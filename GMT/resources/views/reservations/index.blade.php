 ...
 @section('content')
     @if (session('success') && session('reservation_created'))
         <div id="successToast"
             ...
             <button onclick="document.getElementById('successToast').remove()" class="ml-4 text-white/80 hover:text-white">
             ...
             <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-gray-50/80 to-white">
                 <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                     <div>
                         ...
                         <p class="text-sm text-gray-600 mt-1">{{ $reservations->total() }} réservation(s) trouvée(s)</p>
                     </div>
